...
| Concept | Type | Function | Key Property | Example from Lecture |
|---------|------|----------|-------------|----------------------|
| **PDF** | Continuous | f(x) | Area = Probability | Height ~N(165,10²) |
| **PMF** | Discrete | P(X=x) | Sum = 1 | Dice: P(i) = 1/6 |
| **CDF** | Both | F(x) = P(X≤x) | Non-decreasing, 0→1 | F(155)≈0.25, F(165)≈0.5 |
